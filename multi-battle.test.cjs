...
vm.runInContext(`
  ...
  check(SPECIES[SP_BY_ID.kokugainoryu].hidden&&kokugainoryu.types.join('/')==='dragon/dark'&&kokugainoryu.base.hp===110&&kokugainoryu.base.atk===70&&kokugainoryu.base.def===128&&kokugainoryu.base.spa===139&&kokugainoryu.base.spd===128&&kokugainoryu.base.spe===100&&kokugainoryu.img==='image/image/コクガイノリュウ.png'&&kokugainoryu.abilEff==='magicGauge'&&kokugainoryu.moves.some(m=>m.name==='ホウシャズメ'),'Kokugainoryu is hidden before unlock with requested stats, Magic and Radiation Spear');
