...
vm.runInContext(`
  ...
  check(decidueye.abilEff==='longreach'&&selectableTargets('me',M.shadowStitch).includes(fieldTarget)&&selectableTargets('me',M.shadowStitch).includes(benchTarget)&&resolveAttackTarget('me',fieldTarget,M.shadowStitch)===fieldTarget&&resolveAttackTarget('me',benchTarget,M.shadowStitch)===benchTarget,'Decidueye Long Reach can select the front or one bench target');
