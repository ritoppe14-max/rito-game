...
vm.runInContext(`
  ...
  const raikanburian=makeMon(SP_BY_ID.raikanburian,'none','p1');check(raikanburian.types.join('/')==='water/fairy'&&raikanburian.base.hp===105&&raikanburian.base.atk===115&&raikanburian.base.def===130&&raikanburian.base.spa===85&&raikanburian.base.spd===130&&raikanburian.base.spe===103&&raikanburian.abilEff==='sheerforce','Raikanburian has requested Water/Fairy stats and Sheer Force including the global bulk bonus');
