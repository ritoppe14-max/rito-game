...
vm.runInContext(`
  ...
  morpeko.morpekoFirstTarget=null;morpekoTarget.types=['normal'];morpekoTarget.maxHp=morpekoTarget.curHp=100000;const paybackDamage=calcDamage(morpeko,morpekoTarget,M.morpekoPayback,false).dmg;attack(morpeko,morpekoTarget,M.morpekoPayback,'foeImg',()=>{});check(morpekoTarget.curHp===100000-paybackDamage*2,'Hungry Payback hits Morpeko first opponent twice');
