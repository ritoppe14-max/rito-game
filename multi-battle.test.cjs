...
vm.runInContext(`
  ...
  const raikanburikan=makeMon(SP_BY_ID.raikanburikan,'none','p1');check(raikanburikan.types.join('/')==='water/fairy'&&raikanburikan.base.hp===105&&raikanburikan.base.atk===115&&raikanburikan.base.def===130&&raikanburikan.base.spa===85&&raikanburikan.base.spd===130&&raikanburikan.base.spe===103&&raikanburikan.abilEff==='sheerforce','Raikanburikan has requested Water/Fairy stats and Sheer Force including the global bulk bonus');
