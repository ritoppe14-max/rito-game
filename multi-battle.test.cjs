...
vm.runInContext(`
  ...
  morpeko.morpekoFirstTarget=null;morpekoTarget.types=['normal'];morpekoTarget.maxHp=morpekoTarget.curHp=100000;const paybackDamage=calcDamage(morpeko,morpekoTarget,{...M.morpekoPayback,power:110},false).dmg;attack(morpeko,morpekoTarget,M.morpekoPayback,'foeImg',()=>{});check(morpekoTarget.curHp===100000-paybackDamage,'Hungry Payback doubles against Morpeko first opponent');
