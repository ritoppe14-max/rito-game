...
vm.runInContext(`
  ...
  const oomizutengu=makeMon(SP_BY_ID.oomizutengu,'none','p1');check(oomizutengu.types.join('/')==='water/electric'&&oomizutengu.base.hp===85&&oomizutengu.base.atk===85&&oomizutengu.base.def===115&&oomizutengu.base.spa===105&&oomizutengu.base.spd===115&&oomizutengu.base.spe===85&&oomizutengu.img==='image/image/オオミズテング.png'&&oomizutengu.abilEff==='electromorphosis','Oomizutengu has requested Water/Electric stats, image and Electromorphosis');
