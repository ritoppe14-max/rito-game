...
vm.runInContext(`
  ...
  const morpekoFullHp=morpeko.maxHp,fullSpeed=effSpeed(morpeko);check(morpeko.base.hp===58&&morpeko.base.def===88&&morpeko.base.spd===88&&morpeko.morpekoFull&&morpeko.moves[4].name==='激車輪猛烈極悪電流'&&morpeko.moves[4].fifthSlot,'Morpeko starts full with its fifth move and global bulk');
