...
vm.runInContext(`
  ...
  const rivalKai=makeMon(SP_BY_ID.rivalKai,'none','p1');check(rivalKai.name==='ライバルカイ'&&rivalKai.types.join('/')==='water/ghost'&&rivalKai.base.hp===50&&rivalKai.base.atk===123&&rivalKai.base.def===130&&rivalKai.base.spa===73&&rivalKai.base.spd===130&&rivalKai.base.spe===112&&rivalKai.img==='image/image/ライバルカイ.png','Rival Kai has its requested Water/Ghost stats and image');check(ABILS.rivalKai.includes('strongjaw')&&ABILS.rivalKai.includes('swiftswim'),'Rival Kai can select Strong Jaw or Swift Swim');
